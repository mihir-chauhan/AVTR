...
class VisionProcessor {
    ...
    async processVideo(videoPath) {
        ...
        try {
            ...
            page.on('console', (msg) => {
                const text = msg.text();
                if (text.startsWith('[Vision Stream]'))
                    console.log(text);
            ...
            const sdkPath = path_1.default.resolve(process.cwd(), 'node_modules/@overshoot/sdk/dist/index.mjs');
            let sdkSource = fs_1.default.readFileSync(sdkPath, 'utf-8');
